$(document).ready(function() {
    ...
    var K = "&#9818"; /*    black king    */
    var k = "&#9812"; /*    white king    */
    var Q = "&#9819"; /*   black queen    */
    var q = "&#9813"; /*   white queen    */
    var B = "&#9821"; /*   black bishop   */
    var b = "&#9815"; /*   white bishop   */
    var N = "&#9822"; /*   black knight   */
    var n = "&#9816"; /*   white knight   */
    var R = "&#9820"; /*    black rook    */
    var r = "&#9814"; /*    white rook    */
    var P = "&#9823"; /*    black pawn    */
    var p = "&#9817"; /*    white pawn    */


    // multi-dimensional arrays representing the location of the pieces along each sequence of moves
    var moveSequence = [
        [ // Initial board setup
            [R, N, B, Q, K, B, N, R],
            [P, P, P, P, P, P, P, P],
    ...
    for (var i = 0; i < 8; i++) {
        for (var f = 0; f < 8; f++) {
            ...
            document.getElementById("boardSet").innerHTML +=
                "<div class='grid-box'>" + moveSequence[counter][i][f] +
                "</div>";

            if (i % 2 === 0 && f % 2 !== 0 || i % 2 !== 0 && f % 2 ===
                0) {
    ...
    document.querySelector("#back").addEventListener("click",
        function() {
            ...
            document.getElementsByClassName('grid-box').innerHTML =
                null;
            ...
            for (var i = 0; i < 8; i++) {
                for (var f = 0; f < 8; f++) {
                    ...
                    $(".grid-box").eq(i * 8 + f).html(moveSequence[
                        counter][i][f]);
                }
            }
        });
